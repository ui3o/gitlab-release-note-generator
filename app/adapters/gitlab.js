...
exports.createTagReleaseByProjectIdTagNameAndTagId = async (projectId, body) => {
    ...
    Logger.debug(`Create tag release by ProjectIdTagNameAndTagId, uri: ${uri}, body: ${JSON.stringify(body)}`);
...
exports.updateTagReleaseByProjectIdTagNameAndTagId = async (projectId, tagName, body) => {
    ...
    Logger.debug(`Update tag release by ProjectIdTagNameAndTagId, uri: ${uri}, body: ${JSON.stringify(body)}`);
